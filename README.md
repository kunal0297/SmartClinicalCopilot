...
[
  {
    ...
    "evidence": "prompt = self._create_prompt(rule_id, patient_data)"
  },
  {
    "type": "unblinded_ai_call",
    "evidence": "openai.chatcompletion.acreate(model='gpt-4', messages=[{'role': 'system', 'content': 'you are a clinical decision support system that provides clear, evidence-based explanations for medical alerts.'}, {'role': 'user', 'content': prompt}], temperature=0.7, max_tokens=500)"
  }
]
```
